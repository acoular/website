(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b713df58-2537-40e3-a336-94ed792926ac");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b713df58-2537-40e3-a336-94ed792926ac' but no matching script tag was found.")
        }
