(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eb79e544-d406-4d09-ace5-022bf006c16f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eb79e544-d406-4d09-ace5-022bf006c16f' but no matching script tag was found.")
        }
