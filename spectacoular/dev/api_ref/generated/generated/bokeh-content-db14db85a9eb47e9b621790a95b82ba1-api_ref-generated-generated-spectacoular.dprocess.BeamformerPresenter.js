(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eba40a95-fafb-41f3-9c14-e77b4253c7da");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eba40a95-fafb-41f3-9c14-e77b4253c7da' but no matching script tag was found.")
        }
