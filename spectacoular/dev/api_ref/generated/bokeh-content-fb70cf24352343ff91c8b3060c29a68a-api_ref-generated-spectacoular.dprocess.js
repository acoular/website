(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f08c7f27-f22f-43c0-83f6-2695894d5ba9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f08c7f27-f22f-43c0-83f6-2695894d5ba9' but no matching script tag was found.")
        }
