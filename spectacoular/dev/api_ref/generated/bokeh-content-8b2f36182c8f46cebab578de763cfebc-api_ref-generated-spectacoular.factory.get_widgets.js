(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b24b7f11-1250-49f6-a2d3-c91526e0a103");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b24b7f11-1250-49f6-a2d3-c91526e0a103' but no matching script tag was found.")
        }
