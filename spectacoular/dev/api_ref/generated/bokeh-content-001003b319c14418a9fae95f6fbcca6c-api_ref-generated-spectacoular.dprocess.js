(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ba517981-cc7c-43c7-8513-b5612e61a77d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ba517981-cc7c-43c7-8513-b5612e61a77d' but no matching script tag was found.")
        }
