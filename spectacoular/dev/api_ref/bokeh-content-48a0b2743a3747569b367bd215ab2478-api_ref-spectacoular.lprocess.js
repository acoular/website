(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e588daca-52ff-4b11-bbbb-88cf6ec67540");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e588daca-52ff-4b11-bbbb-88cf6ec67540' but no matching script tag was found.")
        }
