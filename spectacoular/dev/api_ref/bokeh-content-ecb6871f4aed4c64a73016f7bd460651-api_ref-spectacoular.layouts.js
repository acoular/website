(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c2b427cc-b6e3-4b05-8115-55a52c04f241");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c2b427cc-b6e3-4b05-8115-55a52c04f241' but no matching script tag was found.")
        }
