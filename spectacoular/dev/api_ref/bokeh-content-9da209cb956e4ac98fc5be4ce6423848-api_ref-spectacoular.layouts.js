(function() {
  const fn = function() {
    ...
    const element = document.getElementById("deed30d1-5a41-48ba-be57-cf47260730d2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'deed30d1-5a41-48ba-be57-cf47260730d2' but no matching script tag was found.")
        }
