(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a04ba76c-ce96-432a-aede-1e5583a858cd");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a04ba76c-ce96-432a-aede-1e5583a858cd' but no matching script tag was found.")
        }
