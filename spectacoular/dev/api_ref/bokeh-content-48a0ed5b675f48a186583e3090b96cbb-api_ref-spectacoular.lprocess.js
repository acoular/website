(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e218507b-fb06-4442-bc7b-15398aa64ed5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e218507b-fb06-4442-bc7b-15398aa64ed5' but no matching script tag was found.")
        }
