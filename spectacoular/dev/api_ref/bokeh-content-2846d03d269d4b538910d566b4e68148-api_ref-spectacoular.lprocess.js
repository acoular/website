(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b6139098-cdd1-43a2-955a-4da6097191a2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b6139098-cdd1-43a2-955a-4da6097191a2' but no matching script tag was found.")
        }
