(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d5e7002b-8bea-485b-8e0e-115469d1a095");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd5e7002b-8bea-485b-8e0e-115469d1a095' but no matching script tag was found.")
        }
