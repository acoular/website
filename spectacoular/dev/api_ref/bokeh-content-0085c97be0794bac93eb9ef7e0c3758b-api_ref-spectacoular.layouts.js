(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c2f7249d-2045-4c9d-99f2-1c26fc052c0b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c2f7249d-2045-4c9d-99f2-1c26fc052c0b' but no matching script tag was found.")
        }
