(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a0beed98-e33e-4256-99d8-7a49160b260d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a0beed98-e33e-4256-99d8-7a49160b260d' but no matching script tag was found.")
        }
