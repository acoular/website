(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ca08c676-ed56-4d17-8750-3fcadb9f88ff");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ca08c676-ed56-4d17-8750-3fcadb9f88ff' but no matching script tag was found.")
        }
