(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b710ff22-4f03-47c2-81d9-bfdc0f3d6337");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b710ff22-4f03-47c2-81d9-bfdc0f3d6337' but no matching script tag was found.")
        }
