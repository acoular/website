(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f8a44621-4a30-4ffb-901e-241c6cf95acd");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f8a44621-4a30-4ffb-901e-241c6cf95acd' but no matching script tag was found.")
        }
