(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e3da8b96-fd09-4efe-a6b5-2f2553e7d842");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e3da8b96-fd09-4efe-a6b5-2f2553e7d842' but no matching script tag was found.")
        }
