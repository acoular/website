(function() {
  const fn = function() {
    ...
    const element = document.getElementById("dd59d164-284d-475b-a9b9-48ab7b10bd45");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'dd59d164-284d-475b-a9b9-48ab7b10bd45' but no matching script tag was found.")
        }
