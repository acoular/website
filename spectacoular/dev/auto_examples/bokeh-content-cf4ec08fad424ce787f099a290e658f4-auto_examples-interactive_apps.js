(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bb73a7db-2e21-424e-963c-651c28ca4da4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bb73a7db-2e21-424e-963c-651c28ca4da4' but no matching script tag was found.")
        }
