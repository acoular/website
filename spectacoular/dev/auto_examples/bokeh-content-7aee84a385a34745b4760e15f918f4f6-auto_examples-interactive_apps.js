(function() {
  const fn = function() {
    ...
    const element = document.getElementById("df71f688-6899-4a82-a67d-5f80cf611891");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'df71f688-6899-4a82-a67d-5f80cf611891' but no matching script tag was found.")
        }
