(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b2c804c8-71fb-450b-b38b-6814d6189668");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b2c804c8-71fb-450b-b38b-6814d6189668' but no matching script tag was found.")
        }
