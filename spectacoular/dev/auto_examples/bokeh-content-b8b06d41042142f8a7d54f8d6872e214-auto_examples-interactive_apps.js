(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d38b4dec-df16-4219-9d4d-e06ca25284b2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd38b4dec-df16-4219-9d4d-e06ca25284b2' but no matching script tag was found.")
        }
